...
class HistorySession(ApplicationSession):
  ...
  def onJoin(self, details):
    ...
    def store_message(msg, details=None):
      print("Message received on {}".format(details.topic))
      HISTORY_SESSION_EVENT_MAP[details.topic] = msg
    ...
    def last_event(topic):
      print("Got request for last event on: {}".format(topic))
